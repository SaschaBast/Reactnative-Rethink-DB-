...
export const SELECT_CONVERSATION = 'conv-user-link/select';
...
export const selectConversation = createAction(SELECT_CONVERSATION, activeConversation => activeConversation);
